...
class apimodel extends CI_Model{
	...
	public function get_coupon_code($where)
	{
		$this->db->select("*");
		$this->db->from("coupon");	
		$this->db->where($where);
	...
	public function check_transacation($where)
	{
		$this->db->select("*");
		$this->db->from("e_transacation");	
		$this->db->where($where);
	...
	public function get_book_buy($where)
	{
		$this->db->select("*");
		$this->db->from("e_transacation");	
		$this->db->join('e_package', 'e_package.id = e_transacation.t_fb_id');
		$this->db->where($where);
		$q = $this->db->get();
		return $q->row();	
	}

							...
							<div id="piil-20" class="container tab-pane fade">
								<form id="save_password" class="mx-auto">
									...
									<div class="form-group">
										...
										onclick="change_password()"> Save</button>
									</div>
								</form>
							</div>
...
<script type="text/javascript">
	...
	function save_setting(){
		...
		$.ajax({
			type:'POST',
			url:'<?php echo base_url(); ?>admin/savesetting' ,
			data:formData,
			cache:false,
			contentType: false,
			processData: false,
	...
	function save_admob(){
		...
		$.ajax({
			type:'POST',
			url:'<?php echo base_url(); ?>admin/save_admob' ,
			data:formData,
			cache:false,
			contentType: false,
			processData: false,
	...
	function save_signal_noti(){
		...
		$.ajax({
			type:'POST',
			url:'<?php echo base_url(); ?>admin/save_signal_noti' ,
			data:formData,
			cache:false,
			contentType: false,
			processData: false,
